...
STATION_FIXES: Dict[str, Dict[str, object]] = {
    ...
    "136.897": {"name": "Москва-Сити"},                           # Тестовская (МЦД-4) → Москва-Сити
}
...
EDGE_REMOVE: List[Tuple[str, str, EdgeType]] = [
    ...
    # Ермакова Роща (скрыта): убираем перегоны через неё, заменим прямым Кутузовская→Москва-Сити
    ("136.898", "136.896", EdgeType.same_line),   # Кутузовская (МЦД-4) — Ермакова Роща (МЦД-4)
    ("136.896", "136.897", EdgeType.same_line),   # Ермакова Роща (МЦД-4) — Москва-Сити (МЦД-4)
...
EDGE_ADD: List[Tuple[str, str, EdgeType]] = [
    ...
    ("5.20", "5.82", EdgeType.same_line),          # Белорусская — Новослободская (замыкание Кольцевой)
    ...
    ("95.538", "131.702", EdgeType.transfer),     # Шелепиха (МЦК) — Тестовская (МЦД-1)

    ("97.602", "131.702", EdgeType.transfer),     # Шелепиха (БКЛ) — Тестовская (МЦД-1)
    ...
    # Перегоны МЦД-4: Кутузовская → Москва-Сити → Белорусская (в обход скрытой Ермаковой Рощи)
    ("136.898", "136.897", EdgeType.same_line),   # Кутузовская (МЦД-4) — Москва-Сити (МЦД-4)
    ("136.897", "136.894", EdgeType.same_line),   # Москва-Сити (МЦД-4) — Белорусская (МЦД-4)
    # Переходы Москва-Сити (МЦД-4)
    ("136.897", "131.702", EdgeType.transfer),    # Москва-Сити (МЦД-4) — Тестовская (МЦД-1)
    ("136.897", "4.172", EdgeType.transfer),      # Москва-Сити (МЦД-4) — Деловой центр (Выставочная)
    ("136.897", "133.468", EdgeType.transfer),    # Москва-Сити (МЦД-4) — Деловой центр (Солнц.)
    ("136.897", "95.537", EdgeType.transfer),     # Москва-Сити (МЦД-4) — Деловой центр (МЦК)
    ("136.897", "95.538", EdgeType.transfer),     # Москва-Сити (МЦД-4) — Шелепиха (МЦК)
    ("136.897", "4.179", EdgeType.transfer),      # Москва-Сити (МЦД-4) — Москва-Сити (Филёвская)
